<?php
    ...
    #[Route('admin/user/{idUser}/payment', name: 'app_user_payment_')]
    class PaymentMethodController extends AbstractController
    {
        ...
        public function index(EntityManagerInterface $em, int $idUser): Response
        {
            ...
            return $this->render('user/payment/list.html.twig', [
                'user' => $user,
        ...
        {
            $user = $em->getRepository(User::class)->find($idUser);
            $action = $this->generateUrl('app_user_payment_new', ['type' => $type, 'idUser' => $idUser]);
        ...
        {
            $paymentMethod = $em->getRepository(PaymentMethod::class)->find($id);
            $action = $this->generateUrl('app_user_payment_edit', ['id' => $id, 'idUser' => $idUser]);
        ...
        public function delete(EntityManagerInterface $em, Request $request, int $idUser, int $id): Response
        {
            ...
            return $this->redirectToRoute('app_user_payment_list', ['idUser' => $idUser], Response::HTTP_SEE_OTHER);
        }
        ...
        protected function handleForm(
            ...
            if ($form->isSubmitted() && $form->isValid()) {
                ...
                if ($redirect) {
                    ...
                    return $this->redirectToRoute('app_user_payment_list', ['idUser' => $paymentMethod->getUser()->getId()], Response::HTTP_SEE_OTHER);
                }
            }

            return $this->render('user/payment/form.html.twig', [
                'form' => $form,
                'paymentMethod' => $paymentMethod,
            ]);
        }
