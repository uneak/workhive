<?php
    ...
    #[Route('admin/reservation/{idReservation}/equipment', name: 'app_reservation_equipment_')]
    class ReservationEquipmentController extends AbstractController
    {
        ...
        public function index(EntityManagerInterface $em, int $idReservation): Response
        {
            ...
            return $this->render('reservation/equipment/list.html.twig', [
        ...
        {
            $reservation = $em->getRepository(Reservation::class)->find($idReservation);
            $action = $this->generateUrl('app_reservation_equipment_new', ['idReservation' => $idReservation]);
        ...
        public function show(EntityManagerInterface $em, int $id): Response
        {
            ...
            return $this->render('reservation/equipment/show.html.twig', [
        ...
        {
            $reservationEquipment = $em->getRepository(ReservationEquipment::class)->find($id);
            $action = $this->generateUrl('app_reservation_equipment_edit', ['id' => $id, 'idReservation' => $idReservation]);
        ...
        public function delete(EntityManagerInterface $em, Request $request, int $idReservation, int $id): Response
        {
            ...
            return $this->redirectToRoute('app_reservation_equipment_list', ['idReservation' => $idReservation], Response::HTTP_SEE_OTHER);
        }
        ...
        protected function handleForm(
            ...
            if ($form->isSubmitted() && $form->isValid()) {
                ...
                if ($redirect) {
                    ...
                    return $this->redirectToRoute('app_reservation_equipment_list', ['idReservation' => $reservationEquipment->getReservation()->getId()], Response::HTTP_SEE_OTHER);
                }
            }

            return $this->render('reservation/equipment/form.html.twig', [
                'form' => $form,
                'reservationEquipment' => $reservationEquipment,
            ]);
        }
