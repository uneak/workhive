<?php
    ...
    #[Route('admin/room/{idRoom}/rate', name: 'app_room_rate_')]
    class RoomRoleRateController extends AbstractController
    {
        ...
        public function index(EntityManagerInterface $em, int $idRoom): Response
        {
            ...
            return $this->render('room/rate/list.html.twig', [
                'room' => $room,
        ...
        {
            $room = $em->getRepository(Room::class)->find($idRoom);
            $action = $this->generateUrl('app_room_rate_new', ['idRoom' => $idRoom]);
        ...
        public function show(EntityManagerInterface $em, int $id): Response
        {
            ...
            return $this->render('room/rate/show.html.twig', [
        ...
        {
            $roomRoleRate = $em->getRepository(RoomRoleRate::class)->find($id);
            $action = $this->generateUrl('app_room_rate_edit', ['id' => $id, 'idRoom' => $idRoom]);
        ...
        public function delete(EntityManagerInterface $em, Request $request, int $idRoom, int $id): Response
        {
            ...
            return $this->redirectToRoute('app_room_rate_list', ['idRoom' => $idRoom], Response::HTTP_SEE_OTHER);
        }
        ...
        protected function handleForm(
            ...
            if ($form->isSubmitted() && $form->isValid()) {
                ...
                if ($redirect) {
                    ...
                    return $this->redirectToRoute('app_room_rate_list', ['idRoom' => $roomRoleRate->getRoom()->getId()], Response::HTTP_SEE_OTHER);
                }
            }

            return $this->render('room/rate/form.html.twig', [
                'form' => $form,
                'roomRoleRate' => $roomRoleRate,
            ]);
        }
