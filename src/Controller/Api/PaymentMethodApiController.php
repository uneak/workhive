...
class PaymentMethodApiController extends AbstractApiController
{
        ...
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(
                    type: 'array',
                    items: new OA\Items(ref: new Model(type: PaymentMethod::class, groups: ['payment_method:read']))
                )
            ),
            new OA\Response(
                response: 401,
    ...
    {
        return $this->listEntities($request, 'payment_method:read');
    }
    ...
    #[OA\Post(
        ...
        requestBody: new OA\RequestBody(
            ...
            required: true,
            content: new OA\JsonContent(ref: new Model(type: PaymentMethod::class, groups: ['payment_method:write']))
        ),
        tags: ['payment-methods'],
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(property: 'message', type: 'string', example: 'Payment method created successfully'),
                        new OA\Property(property: 'payment_method', ref: new Model(type: PaymentMethod::class, groups: ['payment_method:read']))
                    ]
                )
            ),
            new OA\Response(
    ...
    #[OA\Get(
        ...
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(ref: new Model(type: PaymentMethod::class, groups: ['payment_method:read']))
            ),
            new OA\Response(
                response: 404,
    ...
    {
        return $this->showEntity($id, 'payment_method:read');
    }
    ...
    #[OA\Put(
        ...
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(property: 'message', type: 'string', example: 'Payment method updated successfully'),
                        new OA\Property(property: 'payment_method', ref: new Model(type: PaymentMethod::class, groups: ['payment_method:read']))
                    ]
                )
            ),
