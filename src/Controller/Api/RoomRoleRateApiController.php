    ...
    class RoomRoleRateApiController extends AbstractApiController
    {
                    ...
                    content: new OA\JsonContent(
                        properties: [
                            new OA\Property(property: 'data', type: 'array',
                                items: new OA\Items(ref: new Model(type: RoomRoleRate::class,
        ...
        #[OA\Post(
            ...
            requestBody: new OA\RequestBody(
                ...
                required: true,
                content: new OA\JsonContent(ref: new Model(type: RoomRoleRate::class,
                    ...
                    content: new OA\JsonContent(
                        properties: [
                            new OA\Property(property: 'message', type: 'string',
                                example: 'Room role rate created successfully'),
                            new OA\Property(property: 'room_role_rate', ref: new Model(type: RoomRoleRate::class,
                                groups: [ObjectModel::READ_PREFIX]))
                        ]
                    )
                ),
            ...
            responses: [
                new OA\Response(
                    ...
                    content: new OA\JsonContent(
                        properties: [
                            new OA\Property(property: 'message', type: 'string',
                                example: 'Room role rate updated successfully'),
                            new OA\Property(property: 'room_role_rate', ref: new Model(type: RoomRoleRate::class,
                                groups: [ObjectModel::READ_PREFIX]))
                        ]
                    )
