                    ...
                    content: new OA\JsonContent(
                        properties: [
                            new OA\Property(property: 'data', type: 'array',
                                items: new OA\Items(ref: new Model(type: Payment::class,
                ...
                new OA\Response(
                    ...
                    content: new OA\JsonContent(
                        properties: [
                            ...
                            new OA\Property(property: 'payment', ref: new Model(type: Payment::class,
                                groups: [ObjectModel::READ_PREFIX]))
                        ]
                    )
                ),
        ...
        #[OA\Get(
            ...
            responses: [
                new OA\Response(
                    ...
                    content: new OA\JsonContent(ref: new Model(type: Payment::class,
                        groups: [ObjectModel::READ_PREFIX]))
                ),
                new OA\Response(
                    response: 404,
