    ...
    class EquipmentApiController extends AbstractApiController
    {
            ...
            responses: [
                new OA\Response(
                    ...
                    content: new OA\JsonContent(
                        type: 'array',
                        items: new OA\Items(ref: new Model(type: Equipment::class, groups: [ObjectModel::READ_PREFIX]))
                    )
                ),
                new OA\Response(
                    response: 401,
        ...
        #[OA\Post(
            ...
            requestBody: new OA\RequestBody(
                ...
                required: true,
                content: new OA\JsonContent(ref: new Model(type: Equipment::class,
                ...
                new OA\Response(
                    ...
                    content: new OA\JsonContent(
                        properties: [
                            ...
                            new OA\Property(property: 'equipment', ref: new Model(type: Equipment::class,
