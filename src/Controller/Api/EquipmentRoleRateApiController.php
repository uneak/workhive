...
class EquipmentRoleRateApiController extends AbstractApiController
{
        ...
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(
                    type: 'array',
                    items: new OA\Items(ref: new Model(type: EquipmentRoleRate::class, groups: ['equipment_role_rate:read']))
                )
            ),
            new OA\Response(
                response: 401,
    ...
    {
        return $this->listEntities($request, 'equipment_role_rate:read');
    }
    ...
    #[OA\Post(
        ...
        requestBody: new OA\RequestBody(
            ...
            required: true,
            content: new OA\JsonContent(ref: new Model(type: EquipmentRoleRate::class, groups: ['equipment_role_rate:write']))
        ),
        tags: ['equipment-role-rates'],
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(property: 'message', type: 'string', example: 'Equipment role rate created successfully'),
                        new OA\Property(property: 'equipment_role_rate', ref: new Model(type: EquipmentRoleRate::class, groups: ['equipment_role_rate:read']))
                    ]
                )
            ),
            new OA\Response(
    ...
    #[OA\Get(
        ...
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(ref: new Model(type: EquipmentRoleRate::class, groups: ['equipment_role_rate:read']))
            ),
            new OA\Response(
                response: 404,
    ...
    {
        return $this->showEntity($id, 'equipment_role_rate:read');
    }
    ...
    #[OA\Put(
        ...
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(property: 'message', type: 'string', example: 'Equipment role rate updated successfully'),
                        new OA\Property(property: 'equipment_role_rate', ref: new Model(type: EquipmentRoleRate::class, groups: ['equipment_role_rate:read']))
                    ]
                )
            ),
