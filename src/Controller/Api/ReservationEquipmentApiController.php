    ...
    class ReservationEquipmentApiController extends AbstractApiController
    {
                    ...
                    content: new OA\JsonContent(
                        properties: [
                            new OA\Property(property: 'data', type: 'array',
                                items: new OA\Items(ref: new Model(type: ReservationEquipment::class,
        ...
        #[OA\Post(
            ...
            requestBody: new OA\RequestBody(
                ...
                required: true,
                content: new OA\JsonContent(ref: new Model(type: ReservationEquipment::class,
                    ...
                    content: new OA\JsonContent(
                        properties: [
                            new OA\Property(property: 'message', type: 'string',
                                example: 'Reservation equipment created successfully'),
                            new OA\Property(property: 'reservation_equipment',
                                ref: new Model(type: ReservationEquipment::class, groups: [ObjectModel::READ_PREFIX]))
                        ]
                    )
                ),
                new OA\Response(
            ...
            responses: [
                ...
                new OA\Response(
                    ...
                    content: new OA\JsonContent(
                        properties: [
                            new OA\Property(property: 'error', type: 'string',
                                example: 'Reservation equipment not found')
                        ]
                    )
                )
            ]
            ...
            responses: [
                new OA\Response(
                    ...
                    content: new OA\JsonContent(
                        properties: [
                            new OA\Property(property: 'message', type: 'string',
                                example: 'Reservation equipment updated successfully'),
                            new OA\Property(property: 'reservation_equipment',
                                ref: new Model(type: ReservationEquipment::class, groups: [ObjectModel::READ_PREFIX]))
                        ]
                    )
