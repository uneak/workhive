...
class ReservationEquipmentApiController extends AbstractApiController
{
        ...
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(
                    type: 'array',
                    items: new OA\Items(ref: new Model(type: ReservationEquipment::class, groups: ['reservation_equipment:read']))
                )
            ),
            new OA\Response(
                response: 401,
    ...
    {
        return $this->listEntities($request, 'reservation_equipment:read');
    }
    ...
    #[OA\Post(
        ...
        requestBody: new OA\RequestBody(
            ...
            required: true,
            content: new OA\JsonContent(ref: new Model(type: ReservationEquipment::class, groups: ['reservation_equipment:write']))
        ),
        tags: ['reservation-equipment'],
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(
                    properties: [
                        ...
                        new OA\Property(property: 'reservation_equipment', ref: new Model(type: ReservationEquipment::class, groups: ['reservation_equipment:read']))
                    ]
                )
            ),
            new OA\Response(
    ...
    #[OA\Get(
        ...
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(ref: new Model(type: ReservationEquipment::class, groups: ['reservation_equipment:read']))
            ),
            new OA\Response(
                response: 404,
    ...
    {
        return $this->showEntity($id, 'reservation_equipment:read');
    }
