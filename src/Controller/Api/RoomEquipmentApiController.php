    ...
    class RoomEquipmentApiController extends AbstractApiController
    {
                    ...
                    content: new OA\JsonContent(
                        properties: [
                            new OA\Property(property: 'data', type: 'array',
                                items: new OA\Items(ref: new Model(type: RoomEquipment::class,
        ...
        #[OA\Post(
            ...
            requestBody: new OA\RequestBody(
                ...
                required: true,
                content: new OA\JsonContent(ref: new Model(type: RoomEquipment::class,
                    ...
                    content: new OA\JsonContent(
                        properties: [
                            new OA\Property(property: 'message', type: 'string',
                                example: 'Room equipment created successfully'),
                            new OA\Property(property: 'room_equipment', ref: new Model(type: RoomEquipment::class,
                                groups: [ObjectModel::READ_PREFIX]))
                        ]
                    )
                ),
            ...
            responses: [
                new OA\Response(
                    ...
                    content: new OA\JsonContent(
                        properties: [
                            new OA\Property(property: 'message', type: 'string',
                                example: 'Room equipment updated successfully'),
                            new OA\Property(property: 'room_equipment', ref: new Model(type: RoomEquipment::class,
                                groups: [ObjectModel::READ_PREFIX]))
                        ]
                    )
