<?php
    ...
    #[Route('admin/room/{idRoom}/equipment', name: 'app_room_equipment_')]
    class RoomEquipmentController extends AbstractController
    {
        ...
        public function index(EntityManagerInterface $em, int $idRoom): Response
        {
            ...
            return $this->render('room/equipment/list.html.twig', [
                'room' => $room,
        ...
        {
            $room = $em->getRepository(Room::class)->find($idRoom);
            $action = $this->generateUrl('app_room_equipment_new', ['idRoom' => $idRoom]);
        ...
        public function show(EntityManagerInterface $em, int $id): Response
        {
            ...
            return $this->render('room/equipment/show.html.twig', [
        ...
        {
            $roomEquipment = $em->getRepository(RoomEquipment::class)->find($id);
            $action = $this->generateUrl('app_room_equipment_edit', ['id' => $id, 'idRoom' => $idRoom]);
        ...
        public function delete(EntityManagerInterface $em, Request $request, int $idRoom, int $id): Response
        {
            ...
            return $this->redirectToRoute('app_room_equipment_list', ['idRoom' => $idRoom], Response::HTTP_SEE_OTHER);
        }
        ...
        protected function handleForm(
            ...
            if ($form->isSubmitted() && $form->isValid()) {
                ...
                if ($redirect) {
                    ...
                    return $this->redirectToRoute('app_room_equipment_list', ['idRoom' => $roomEquipment->getRoom()->getId()], Response::HTTP_SEE_OTHER);
                }
            }

            return $this->render('room/equipment/form.html.twig', [
                'form' => $form,
                'roomEquipment' => $roomEquipment,
            ]);
        }
